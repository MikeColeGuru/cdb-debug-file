...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
Lexample2.main$a$1_0$1==.
_main_a_65536_1:
	.ds 2
Lexample2.main$b$1_0$1==.
_main_b_65536_1:
	.ds 2
Lexample2.main$c$1_0$1==.
_main_c_65536_1:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$example2.c$1$0_0$1 ==.
;	../src/example2.c:1: void main() {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
	C$example2.c$2$2_0$1 ==.
;	../src/example2.c:2: volatile int a = 1;
	mov	_main_a_65536_1,#0x01
	mov	(_main_a_65536_1 + 1),#0x00
	C$example2.c$3$2_0$1 ==.
;	../src/example2.c:3: volatile int b = 2;
	mov	_main_b_65536_1,#0x02
	mov	(_main_b_65536_1 + 1),#0x00
	C$example2.c$4$1_0$1 ==.
;	../src/example2.c:4: volatile int c = a + b;
